...
const SingleArticleLoding = () => {
  return (
    <section className='pt-40 fix-height container w-full px-5 md:w-3/4 m-auto mt-8 animate-pulse'>
...
export default SingleArticleLoding